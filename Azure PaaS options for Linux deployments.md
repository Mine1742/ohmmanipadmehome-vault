...
- [**JBoss EAP on Azure**](https://learn.microsoft.com/en-us/azure/developer/java/ee/jboss-on-azure) provides a complete environment to build, run, deploy, and manage enterprise Java applications. Choose among three Azure hosting options: Azure App Service, Azure Red Hat OpenShift (ARO), and Azure Virtual Machines/VM Scale Sets. Red Hat and Microsoft jointly develop and support all three solutions.
...
- [Azure Database for MySQL](https://azure.microsoft.com/pricing/purchase-options/azure-account?cid=msft_learn_841c75ad-f7ed-dee1-d646-acbdaaa54760)
