...
4. Select Add > Add role assignment to open the Add role assignment page.
    ...
    ![Screenshot of the Azure portal in the storage account page, adding a new role to a managed identity.](https://learn.microsoft.com/en-us/training/wwl-sci/implement-access-management-for-azure-resources/media/managed-identity-role-assignment.png)
...
6. Select the managed identity you want assigned.
    ...
    ![Screenshot of the Azure portal in the key vault page, choose the managed identity to grant role and access to.](https://learn.microsoft.com/en-us/training/wwl-sci/implement-access-management-for-azure-resources/media/managed-identity-select.png)
