...
## Campaign focus schedule
Before drafting, find the entry below whose date range covers today and center all
new post drafts on that theme instead of pulling generically from the full mission —
this overrides normal topic selection but not actual event dates/details, which still
come from [[Dao of Life Meetings]]. Outside of any listed window, cover the full range
of pillars as normal. **Delete an entry once its window has fully passed** so the
schedule stays current instead of accumulating stale windows.

- **2026-08-06 → 2026-09-07 (Labor Day):** Worker solidarity and building a healthy,
  happy working class — fair labor, dignity of work, rest/work-life balance, mutual
  aid among workers, honoring the people who feed/build/clothe us. Skip other pillars
  (climate, gardening, hunger relief, etc.) unless an already-scheduled service
  requires it.
- **2026-09-08 → 2026-10-12 (Indigenous Peoples' Day):** Improving the lives of
  Indigenous/Native peoples, both domestically and worldwide — land rights,
  self-determination, cultural preservation, mutual aid with Indigenous communities,
  solidarity against displacement/exploitation. **Include several posts specifically
  about the Maya people of the Chiapas region, Mexico.** Ground factual claims in real
  research rather than invented or stereotyped detail — pull from
  [[Dao of Life Source Leaders List]] where relevant, and delegate background research
  (history, current conditions, specific mutual-aid/solidarity organizations active in
  Chiapas) to the `dao-of-life-research` agent before drafting rather than guessing.
...
### Harvest Ritual — Instagram — 2026-07-31
🌾 Harvest Ritual — September 20

Join us as we gather to give thanks for the season's abundance. Together we'll share a meal, distribute produce to our community, and reflect on gratitude, solidarity, and abundance.
...
We gather twice a month to reflect, breathe, and act together — a candle lit, the Creed spoken, a reading and reflection, silent meditation, an act of service, and a closing circle. No dogma, no pressure — just a community walking a shared path of peace, solidarity, and care for the Earth.
