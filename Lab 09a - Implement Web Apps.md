...
[![Diagram of the tasks.](https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/az104-lab09a-architecture.png)](https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/az104-lab09a-architecture.png)
...
2. Under **SCM Basic Auth Publishing Credentials**, enable the checkbox and select **Apply**. Next, select **Deployment Center** then **Settings**.
...
4. If you have a staging slot, open **Azure Cloud Shell** and run the following command to set the staging slot minimum elastic instance count to 1 before selecting **Save**:
    ...
    [![Screenshot of the autoscale page.](https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/az104-lab09a-autoscale.png)](https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/az104-lab09a-autoscale.png)
