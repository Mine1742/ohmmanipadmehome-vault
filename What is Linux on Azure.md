...
- If you bring your own Linux distribution, follow [Azure guidelines to prepare your image](https://learn.microsoft.com/en-us/azure/virtual-machines/linux/create-upload-generic).
