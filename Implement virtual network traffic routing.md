...
![Screenshot of the next hop drop-down.](https://learn.microsoft.com/en-us/training/wwl-azure/introduction-to-azure-virtual-networks/media/create-custom-route-0e4d9372.png)
...
Imagine your attempts to connect to a specific virtual machine (VM) in your Azure virtual network consistently fail. You can diagnose a routing problem by viewing the effective routes for a virtual machine network interface. You can view the [effective routes](https://learn.microsoft.com/en-us/azure/virtual-network/diagnose-network-routing-problem#diagnose-using-azure-portal) for each network interface by using the Azure portal.

![Screenshot of the Azure portal NIC.](https://learn.microsoft.com/en-us/training/wwl-azure/introduction-to-azure-virtual-networks/media/view-nics-a9fe039b.png)

## Check your knowledge

1. 

Which is a valid next hop for a user defined custom route?
...
Configure every resource with a static IP address.

View the effective routes for each NIC.

Use forced tunneling to control traffic flow.