...
[![Diagram of the tasks.](https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/az104-lab07-architecture.png)](https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/az104-lab07-architecture.png)
...
13. In the **Data management** blade, select **Lifecycle management**, and then select **Add a rule**.
    ...
    [![Screenshot move to cool rule conditions.](https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/az104-lab07-movetocool.png)](https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/az104-lab07-movetocool.png)
...
3. Click **+ Add container** and **Create** a container with the following settings:
    ...
    [![Screenshot of create a container.](https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/az104-lab07-create-container.png)](https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/az104-lab07-create-container.png)
...
2. Next, navigate to **Access Control (IAM)**, click **Add role assignment**, select the **Storage Blob Data Contributor** role and **Storage File Data Privileged Contributor** role, assign it to your user account, and click **Review + assign**.
    
3. Once access is configured, select your **data** container and then click **Upload**.
    
4. On the **Upload blob** blade, expand the **Advanced** section.
...
6. Confirm you have a new folder, and your file was uploaded.
    
7. Select your upload file and review the ellipsis (…) options including **Download**, **Delete**, **Change tier**, and **Acquire lease**.
    
8. Select the uploaded file to open its Overview panel, then copy the URL using the **Copy to clipboard** button in the Properties table. Paste the URL into a new **InPrivate** browser window.
    
9. You should be presented with an XML-formatted message stating **ResourceNotFound** or **PublicAccessNotPermitted**.
...
6. After the file share is created, an informational banner will appear prompting you to enable backup — you can disregard this message and continue.
    ...
    [![Screenshot of the create file share page.](https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/az104-lab07-create-share.png)](https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/az104-lab07-create-share.png)
...
[![Screenshot unauthorized access.](https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/az104-lab07-notauthorized.png)](https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/az104-lab07-notauthorized.png)
