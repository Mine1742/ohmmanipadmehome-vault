...
[![Lab 05 architecture diagram](https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/az104-lab05-architecture.png)](https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/az104-lab05-architecture.png)
...
4. On the Basics tab, use the following information to complete the form, and then select **Next : Disks >**. For any setting not specified, leave the default value.
    ...
    [![Screenshot of Basic virtual machine creation page.](https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/az104-lab05-createcorevm.png)](https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/az104-lab05-createcorevm.png)
...
3. Use the following information to complete the fields on the **Connection troubleshoot** page.
    ...
    |Source port|_Blank_|
    |Diagnostic tests|_Defaults_|
    
    [![Azure Portal showing Connection Troubleshoot settings.](https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/az104-lab05-connection-troubleshoot.png)](https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/az104-lab05-connection-troubleshoot.png)
...
4. It may take a couple of minutes for the script to time out. The top of the page shows an informational message _Script execution in progress…_
...
5. The test connection should succeed because peering has been configured. Your computer name and remote address in this graphic may be different.
    ...
    [![PowerShell window with Test-NetConnection succeeded.](https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/az104-lab05-success.png)](https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/az104-lab05-success.png)
