...
- **Marketplace Insights (sold-comp pricing) confirmed restricted access, 2026-08-07** — a real request returned "Insufficient permissions to fulfill the request." Community reports suggest individual/hobbyist accounts often don't get approved even after applying — worth trying eBay's "Application Growth Check" if you want, but don't expect it. Browse API (card details) is a separate, unrestricted API and works regardless
